...
<div class="container p-10 ">
    ...
    <div class="flex justify-center mt-4 text-blue-600 ">
     <h2 class="FP-Menu ">Règlements</h2>
    </div>
     ...
     <form action="{{ route('Ajout_Client') }}" method="post" >
         ...
         <div class="flex flex-row p-3 flex-wrap justify-center  ">
            ...
            <div class="flex flex-row p-3 w-full  ">
                ...
                <div class="flex flex-row mx-4 my-4 md:w-1/2 justify-center  ">
                    <label for="montant" class="FP-Menu ml-2 p-2" >Montant nette du reglement</label>
                    <input type="text" name="montant" class="border-2  p-2  focus:outline-none focus:border-2 focus:border-blue-400 rf" required>
                </div>
         ...
         <div class="flex justify-center mb-4">
             <div class="flex justify-between  mt-4  w-1/3 ">
                 ...
                 <button type="submit" class="FP-Menu bg-indigo-200 p-3 rounded-sm hover:bg-[#ADD8E6]">Effectuer l'operation </button>
                 <a href="{{ route('Dashboard')}}" class="FP-Menu bg-indigo-200 p-3 rounded-sm hover:bg-red-400">Retour </a>
