...
<body class=" bg-slate-300 flex flex-col bg-white items-center element">
    ...
    <div class="py-10 px-5   h-[160vh]  bg-white m-10 flex flex-col">
        ...
        <div class="flex body flex-col  justify-center">
            <div class="mt-4  flex flex-row justify-between items-center p-8">
                ...
                <p class="FP-error"><span class="font-bold">Facture: </span>n°{{$donne_facture->num_factures}}</p>
    ...
    <script>
        ...
        taille.classList.add('h-[20vh]');
        taille.classList.add('mt-[30px]');

        var tailles = document.querySelector('.secondpart');mt-[20px]

        tailles.classList.add('mt-[20px]');
